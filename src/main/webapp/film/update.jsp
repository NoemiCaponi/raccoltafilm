					...
					<div class="form-row">
						<div class="form-group col-md-6">
							<label>Titolo</label> <input type="text" name="titolo" id="titolo"
								class="form-control" value="${update_film_attr.titolo}">
						</div>

						<div class="form-group col-md-6">
							<label>Genere</label> <input type="text" name="genere" id="genere"
								class="form-control" value="${update_film_attr.genere}">
						</div>
					</div>
					...
					<div class="form-row">
						<div class="form-group col-md-6">
							<label>Data di Pubblicazione</label> <input class="form-control"
								type="date" id="dataPubblicazione" value="${update_film_attr.dataPubblicazione}"
								title="formato : gg/mm/aaaa" name="dataPubblicazione">
						</div>
						<div class="form-group col-md-6">
							<label>Durata (minuti)</label> <input type="number"
								class="form-control" id="minutiDurata" name="minutiDurata"
