					...
					<form method="post" action="ExecuteUpdateRegistaServlet" >
						...
						<div class="form-row">
							<div class="form-group col-md-6">
								...
								<input type="text" name="nome" id="nome" class="form-control" value="${update_regista_attr.nome}"required>
							</div>
							
							<div class="form-group col-md-6">
								<label>Cognome <span class="text-danger">*</span></label>
								<input type="text" name="cognome" id="cognome" class="form-control" value="${update_regista_attr.cognome}" required>
							</div>
						</div>
						...
						<div class="form-row">	
							<div class="form-group col-md-6">
								...
								<input type="text" class="form-control" id="nickName" name="nickName" value="${update_regista_attr.nickName}"required>
							</div>
							<div class="form-group col-md-3">
								<label>Data di Nascita <span class="text-danger">*</span></label>
                        		<input class="form-control" id="dataDiNascita" type="date" value="${update_regista_attr.dataDiNascita}"
